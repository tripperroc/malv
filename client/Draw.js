...
line = function(startX, startY, endX, endY, targetContext){
...
// mid point of state
recursiveLine = function(midX, midY,radius){
...
originalCurvedLine = function(startX, startY, endX, endY){
...
curvedLine = function(startX,startY,controlPoints,endX,endY){
...
calcDiff = function(startX,startY,endX,endY){
	a = startX - endX;
	b = startY - endY;
