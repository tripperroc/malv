...
drawingTran = false;		// If a transition is being created
pm = PlacementMode.STATE;	// The placement mode
animating = false;			// If the application is animating the current machine
...
function update(){	
	...
	if( drawingTran == true && clickedState != null && pm.value == PlacementMode.TRANSITION.value ){
...
changePlacement = function(newPlacement){
